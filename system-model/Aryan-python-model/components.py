...
def fwh( m_dot_D, h_D_in, P_D, m_dot_FW, h_FW_in, P_FW, h_T_in, P_T, DT_int, DT, N_hxrs): 
    ...
    m_b = 50 #[kg/s]	#upper limit on mass flow
...
P_T = 4.374*10**5
T_T = 253.53 + 273.15
h_T = enthalpy(P = P_T, T = T_T)
# fwh in
m_dot_FW = 395.497
P_FW = 12.94*10**5
T_FW = 105.06 + 273.15
h_FW = enthalpy(P = P_FW, T = T_FW)
DT = 110.61-105.06
P_sat = 4.374e5
T_sat = t_sat( P = P_sat)+0.01
DT_TTD = T_sat - 273.15 - 143.24
N_hxrs = 30
ret = fwh( 0, 0, 0, m_dot_FW, h_FW, P_FW, h_T, P_T, 6.3, DT, N_hxrs)
# m_req = 25.77 [kg/s]
#print(ret[0])
...
if __name__ == "__main__":
    ...
    DT_int_2 = 2.9 #[K]	//internal pinch point
    DT_2 = 5.55 #[K]	//approach temperature on cold side
    N_hxrs = 5
    
    ret = fwh(m_given[38], h_given[38], P_given[38], m_given[25], h_given[25], P_given[25], h_given[18],  P_given[18], DT_int_2, DT_2, N_hxrs)
