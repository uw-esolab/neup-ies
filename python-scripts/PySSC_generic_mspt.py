...
if __name__ == "__main__":
	ssc = PySSC()
	#print ('Current folder =   neup-ies/python-scripts')
	print ('SSC Version = ', ssc.version())
	print ('SSC Build Information = ', ssc.build_info().decode("utf - 8"))
	ssc.module_exec_set_print(0)
	data = ssc.data_create()
	#ssc.data_set_string( data, b'solar_resource_file', b' /build/sam/deploy/solar_resource/tucson_az_32.116521_-110.933042_psmv3_60_tmy.csv' );
	ssc.data_set_number( data, b'ppa_multiplier_model', 0 )
	#.data_set_array_from_csv( data, b'dispatch_factors_ts', b' /neup-ies/python-scripts/dispatch_factors_ts.csv');
	...
	#ssc.data_set_matrix_from_csv( data, b'ud_ind_od', b' /neup-ies/python-scripts/ud_ind_od.csv');
	...
	#ssc.data_set_array_from_csv( data, b'wlim_series', b' neup-ies/python-scripts/wlim_series.csv');
	...
	#ssc.data_set_matrix_from_csv( data, b'helio_positions', b' neup-ies/python-scripts/helio_positions.csv');
	...
	#ssc.data_set_array_from_csv( data, b'grid_curtailment', b' neup-ies/python-scripts/grid_curtailment.csv');
