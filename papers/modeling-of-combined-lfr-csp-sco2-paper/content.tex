...
\bl{also why this isnt really an addition turbine, it is using the turbines that power the compressors}
...
\hl{The values for the three non-charging cycle models with a focus on producing positive alternator power (provide electrical power to the grid), 2-cycle configuration composed of C-LFR-ON and C-CSP-ON, C-1HTR1T-ON, and C-2HTR3T-ON,} are displayed in Table \ref{tab-noncharg}. 
