...
\Author{Brian White $^{1}$, Michael Wagner $^{1,}$\orcidB{}, Ty Neises$^{3}$, Cory Stansbury$^{4}$, and Ben Lindley $^{2}$*\orcidA{}}

% MDPI internal command: Authors, for metadata in PDF
\AuthorNames{Brian White, Michael Wagner, Ty Neises, Cory Stansbury and Ben Lindley}

% MDPI internal command: Authors, for citation in the left column
\AuthorCitation{White, B.; Wagner, M., Neises, T., Stansbury, C., Lindley, B.}
...
$^{2}$ \quad Department of Engineering Physics, University of Wisconsin - Madison, 1500 Engineering Drive, Madison, WI 53706, United States\\
$^{3}$ \quad National Renewable Energy Laboratory,Thermal Systems Group, 15013 Denver West Parkway, Golden, CO 80401, United States\\
$^{4}$ \quad Westinghouse Electric Company, Lead Fast Reactor Systems Development, 1000 Westinghouse Dr, Cranberry Twp, PA 16066, United States}
