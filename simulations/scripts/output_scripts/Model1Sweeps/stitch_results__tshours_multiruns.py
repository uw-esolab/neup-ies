...
# -*- coding: utf-8 -*-
"""
Created on Wed Feb 16 09:38:04 2022
...
CombinedStorage = {}
for i, (min_, max_) in enumerate(zip(TES_min, TES_max)):
    ...
    for key in Storage.keys():
        ...
        if i == 0:
            ...
            if key not in exceptions:
                if len(Storage[key].shape) > 1:
                    CombinedStorage[key] = np.vstack([ CombinedStorage[key], Storage[key]  ])
                else:
