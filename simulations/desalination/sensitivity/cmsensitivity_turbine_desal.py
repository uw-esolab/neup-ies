...
# -*- coding: utf-8 -*-
"""
Created on Mon Dec  4 09:56:53 2023

@author: elizabethkeith
"""

"This model generates data for different distillate sales prices ranging from 25% base case to 200% base cases + different turbine sizes ranging from base case to 200% base case"
...
desal_sensitivity                                 = [0.25*0.0021, 0.50*0.0021, 0.75*0.0021, 1.0*0.0021, 1.25*0.0021, 1.50*0.0021, 1.75*0.0021, 2.0*0.0021] 

for j in desal_sensitivity:
    ...
    for i in turbine_sensitivity:
        ...
        model.P_dist                                  = pyomo.Param(initialize=j)                                                           #[$/kg]           Price at which distillate is sold at time t
...
git        
        ...
        title_str = 'turbine+desal'
        title_str = title_str + str(counter_turbine) + '_' + str(counter_desal) + '.csv'
