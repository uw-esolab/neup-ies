...
# -*- coding: utf-8 -*-
"""
Created on Mon Nov 27 23:21:31 2023
...
for i in high_temp_TES_sensitivity:
    ...
    distillate_price_schedule                     = [desal_price_per_kg for n in range(N)]                                                                                #distillate price in San Diego ($/kg) (https://www.sdcwa.org/wp-content/uploads/2020/11/desal-carlsbad-fs.pdf)
    ...
    model.C_cs                                    = pyomo.Param(initialize=i)                                                           #[$/kWh]          Cost associated with cycle thermal energy storage
