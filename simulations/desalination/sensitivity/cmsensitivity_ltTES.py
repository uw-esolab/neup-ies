...
# -*- coding: utf-8 -*-
"""
Created on Mon Nov 27 23:29:33 2023

@author: elizabethkeith
"""


"This model generates data for different low-temperature TES (kWh) prices ranging from 25% base case to 200% base case"
...
high_temp_TES_sensitivity                         = [0.25*20, 0.5*20, 0.75*20, 1*20, 1.25*20, 1.50*20, 1.75*20, 2*20]

counter                                           = 1
for i in high_temp_TES_sensitivity:
    ...
    distillate_price_schedule                     = [desal_price_per_kg for n in range(N)]                                                               #[$/kg]                                                                               #distillate price in San Diego ($/kg) (https://www.sdcwa.org/wp-content/uploads/2020/11/desal-carlsbad-fs.pdf)
    ...
    model.C_ds                                    = pyomo.Param(initialize=i)                                          #[$/kWh]          Cost associated with desal thermal energy storage
