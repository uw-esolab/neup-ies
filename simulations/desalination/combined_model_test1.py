...
def constr_cmass(model, t):
    return model.w_dot[t]          == ((model.eta[t]*W_dot_gen)/m_dot_csteam) * (1.075*model.m_dot_hpt[t] - 0.186*model.m_dot_e[t] - 0.0748)
...
df_out.to_csv('results1.csv', header=True)