...
for dtes in sens_dtes:
    ...
    for turb in sens_turb:
        ...
        outlabs = ['t', 'C_dtes', 'W_dot_gen',  'm_ch', 'm_dh', 'w_dot', 'v_dot', 'm_dot_cs','m_dot_hpt','m_dot_e','m_dot_ds', 'M_cm_max', 'M_dm_max', 'V_dot_max','C_desal']
        ...
        title_str = 'turb' + str(10*(9+counter_turb)) + '_dtes' + str(10*counter_dtes) + '.csv'
