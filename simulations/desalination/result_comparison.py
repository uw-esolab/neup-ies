...
lns1      = ax1.plot(data1.t, data1.P_elec, linewidth=0.5, color='red', label='Electricity Prices')
ax2       = ax1.twinx()
lns2      = ax2.plot(data1.t, data1.w_dot, linewidth=0.5, color='blue', label='Power Output')
...
lns3      = ax3.plot(data1.t, data1.m_dot_e, linewidth=0.1, color='red')
ax4       = ax3.twinx()
lns4      = ax4.plot(data1.t, data1.w_dot, linewidth=0.1, color='blue')
...
lns5      = ax5.plot(data1.t, data1.m_dot_cs, linewidth=0.1, color='red')
ax6       = ax5.twinx()
lns6      = ax6.plot(data1.t, data1.w_dot, linewidth=0.1, color='blue')
...
lns7      = ax7.plot(data1.t, data1.v_dot, linewidth=0.5, color='red', label='Distillate')
ax8       = ax7.twinx()
lns8      = ax8.plot(data1.t, data1.w_dot, linewidth=0.5, color='blue', label='Electricity')
...
lns9      = ax9.plot(data1.t, data1.m_ch, linewidth=0.5, color='red', label='Mass in High Temp TES')
ax10      = ax9.twinx()
lns10     = ax10.plot(data1.t, data1.w_dot, linewidth=0.5, color='blue', label='Power Produced')
lns11     = ax10.plot(data1.t, data1.P_elec, linewidth=0.5, color='green', label='Electricity Prices')
