...
def main(Li_price=70,ED_elec_req=3.5,RO_elec_req=4.5,MED_elec_req=1.0):
    ...
    model.Price_li            = pyo.Param(initialize=Li_price) # units: $/kg,   sales price of lithium
    ...
    return(float(safe_val(model.li_recovered_ed)),float(safe_val(model.v_dot_in['MED'])),float(safe_val(model.v_dot_in['RO'])))
