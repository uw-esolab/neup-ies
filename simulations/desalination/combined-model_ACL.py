...
cost_molten_salt_TES_kWh  = 28.9   # [$/kWh-th], from Gabriel's model
...
outlabs = ['t', 'P_elec','m_ch', 'm_dh', 'w_dot', 'v_dot', 'm_dot_cs','m_dot_hpt','m_dot_e','m_dot_ds', 'M_cm_max', 'M_dm_max', 'V_dot_max']
