...
# -*- coding: utf-8 -*-
"""
Created on Sat Jan 27 22:48:28 2024
...
for j in ['desal', 'ltTES', 'htTES']:
    ...
    for i in range(1,6):
        ...
        for k in range(1,9):
            ...
            tit = '/Users/elizabethkeith/neup-ies/simulations/desalination/sensitivity/output files//data manipulation/turbine' + str(25*(3+i)) + j + str(25*k) + '_cstor.csv'
...
for j in ['desal','ltTES', 'htTES']:
    ...
    for i in range(1,6):
        ...
        for k in range(1,9):
            ...
            sn.stripplot(data=array, alpha=0.1, color='red').set(xlabel='Hour', ylabel='Mass in High-Temp Storage', ylim=[min_mdh_arr[counter],max_mdh_arr[counter]], title='Turbine: ' + turb_val[turb_val_counter] + ' Base \n' + tit_str[tit_str_counter] + ': ' + tit_val[tit_val_counter] + ' Base')
