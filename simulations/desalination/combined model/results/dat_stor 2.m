...
%% format data to create a box plot with amount high-temperature storage inventory at every hour for a year's worth of data %%
...
for ctes = 1:20
    ...
    dat_ctes   = readtable('/Users/elizabethkeith/neup-ies/simulations/desalination/sensitivity/output files/htTES' + string(25*htTES) + '.csv');
...
for turbine = 1:5
    ...
    writematrix(mat_day_ht, 'turbine' + string(25*(3+turbine)) + 'ltTES' + string(25*desal) + '_cstor.csv')
    writematrix(mat_day_lt, 'turbine' + string(25*(3+turbine)) + 'ltTES' + string(25*desal) + '_dstor.csv')
...
for turbine = 1:5
    ...
    writematrix(mat_day_ht, 'turbine' + string(25*(3+turbine)) + 'htTES' + string(25*desal) + '_cstor.csv')
    writematrix(mat_day_lt, 'turbine' + string(25*(3+turbine)) + 'htTES' + string(25*desal) + '_cstor.csv')
