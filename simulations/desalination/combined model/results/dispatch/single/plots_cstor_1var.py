...
# -*- coding: utf-8 -*-
"""
Created on Tue Jan  2 16:41:42 2024
...
for j in ['desal', 'ltTES', 'htTES', 'turbine']:
    ...
    for i in range(1,csv_length[csv_counter]):
        ...
        tit = '/Users/elizabethkeith/neup-ies/simulations/desalination/sensitivity/output files/data manipulation/' + j + str(25*i) + '_cstor.csv'        
...
for j in ['desal','ltTES', 'htTES', 'turbine']:
    ...
    for i in range(1,csv_length[csv_counter]):
        ...
        str_mch = '/Users/elizabethkeith/neup-ies/simulations/desalination/sensitivity/output files/data manipulation/' + j + str(25*i) + '_cstor.csv'
        
        violin_data_mch = pd.read_csv(str_mch, header=None)
        array = violin_data_mch.to_numpy()
        ...
        sn.stripplot(data=y_values, alpha=0.1, color='red').set(xlabel='Hour', ylabel='Mass in High-Temp Storage', ylim=[min_mch_arr[counter],max_mch_arr[counter]], title=tit_str[tit_str_counter]+ ': ' + tit_val[tit_val_counter] + ' Base')
