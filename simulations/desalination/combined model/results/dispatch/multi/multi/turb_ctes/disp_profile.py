...
ctes_counter = list(range(20))
turb_counter = list(range(11))
...
for turb in turb_counter:
    print(str(turb) + ' in turb_counter')
    ...
    for ctes in ctes_counter:
        print(str(ctes) + ' in ctes_counter')
        tit = '../../../../runs/multi/turb_ctes/turb' + str(10*(10+turb)) + '_ctes' + str(10*(1+ctes)) + '.csv'
        dat = pd.read_csv(tit)
...
for turb in turb_counter:
    ...
    for i in ctes_counter:  
        print(str(i)+' in ctes_counter')    
        tit = '../../../../runs/multi/turb_ctes/turb' + str(10*(10+turb)) + '_ctes' + str(10*(1+i)) + '.csv'
        ...
        save_str = 'Turbine Size: ' + str(10*(10+turb)) + '% Base Case \nHigh-Temperature Storage Cost: ' + str(10*(1+i)) + '% Base Case'
        ...
        plt.savefig('figures/turb' + str(10*(10+turb)) + '_ctes' + str(10*(1+i)) + '.png', bbox_inches='tight')
        print('figures/turb' + str(10*(10+turb)) + '_ctes' + str(10*(1+i)) + '.png')
        plt.close('all')
