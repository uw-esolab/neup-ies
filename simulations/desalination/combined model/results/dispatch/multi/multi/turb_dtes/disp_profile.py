...
for turb in turb_counter:
    ...
    for dtes in dtes_counter:
        print(str(dtes) + ' in dist_counter')
        tit = '../../../../runs/multi/turb_dtes/turb' + str(10*(10+turb)) + '_dtes' + str(10*(1+dtes)) + '.csv'
        dat = pd.read_csv(tit)
...
for turb in turb_counter:
    ...
    for i in dtes_counter:  
        print(str(i)+' in dtes_counter')    
        tit = '../../../../runs/multi/turb_dtes/turb' + str(10*(10+turb)) + '_dtes' + str(10*(1+i)) + '.csv'
        ...
        save_str = 'Turbine Size: ' + str(10*(10+turb)) + '% Base Case \nLow-Temperature Storage Cost: ' + str(10*(1+i)) + '% Base Case'
        ...
        plt.savefig('figures/turb' + str(10*(10+turb)) + '_dtes' + str(10*(1+i)) + '.png', bbox_inches='tight')
        print('figures/turb' + str(10*(10+turb)) + '_dtes' + str(10*(1+i)) + '.png')
        plt.close('all')
