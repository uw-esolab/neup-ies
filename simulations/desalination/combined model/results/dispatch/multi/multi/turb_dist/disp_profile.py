...
for turb in turb_counter:
    ...
    for dist in dist_counter:
        print(str(dist) + ' in dist_counter')
        tit = '../../../../runs/multi/turb_dist/turb' + str(10*(10+turb)) + '_dist' + str(10*(1+dist)) + '.csv'
        dat = pd.read_csv(tit)
...
for turb in turb_counter:
    ...
    for i in dist_counter:  
        print(str(i)+' in dist_counter')    
        tit = '../../../../runs/multi/turb_dist/turb' + str(10*(10+turb)) + '_dist' + str(10*(1+i)) + '.csv'
        ...
        plt.savefig('figures/turb' + str(10*(10+turb)) + '_dist' + str(10*(1+i)) + '.png', bbox_inches='tight')
        print('figures/turb' + str(10*(10+turb)) + '_dist' + str(10*(1+i)) + '.png')
        plt.close('all')
