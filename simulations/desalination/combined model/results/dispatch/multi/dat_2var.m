...
dispatch_ctes  = zeros(8760,200);
dispatch_dtes  = zeros(8760,200);
dispatch_powr  = zeros(8760,200);
dispatch_dist  = zeros(8760,200);
...
for turbine = 1:10
    ...
    for dist = 1:20 
        ...
        dat = readtable(strcat('../../runs/multi/turb_dist/turb' + string(10*(9+turbine)) + '_dist' + string(10*dist) + '.csv'));
        ...
        writematrix(dispatch_ctes, 'multi/turb_dist/dispatch_ctes.csv')
        writematrix(dispatch_dtes, 'multi/turb_dist/dispatch_dtes.csv')
        writematrix(dispatch_powr, 'multi/turb_dist/dispatch_powr.csv')
        writematrix(dispatch_dist, 'multi/turb_dist/dispatch_dist.csv')
...
dispatch_ctes  = zeros(8760,5);
dispatch_dtes  = zeros(8760,5);
dispatch_powr  = zeros(8760,5);
dispatch_dist  = zeros(8760,5);
