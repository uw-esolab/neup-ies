"This model generates data for different high-temperature TES prices ranging from 10% base case to 200% base case."
...
for ctes in sens_ctes:
    ...
    outlabs = ['t', 'C_cs', 'W_dot_gen',  'm_ch', 'm_dh', 'w_dot', 'v_dot', 'm_dot_cs','m_dot_hpt','m_dot_e','m_dot_ds', 'M_cm_max', 'M_dm_max', 'V_dot_max','C_desal']
    ...
    title_str = 'ctes' + str(10*counter_ctes) + '.csv'
