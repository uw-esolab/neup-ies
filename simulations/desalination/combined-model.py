...
model.C_cs = pyomo.Param(initialize=10) #[$/kg] Cost associated with cycle thermal energy storage
model.C_ds = pyomo.Param(initialize=5) #[$/kg] Cost associated with desal thermal energy storage
...
#print(inflow_schedule)
#print(efficiency_schedule)
