...
def PVPlant(files):    
    for weather in files:
        if __name__ == "__main__":
        	...
        	ssc.data_free(data);
        annualenergy_list.append(annual_energy)
print(annualenergy_list)

plt.hist(annualenergy_list, bins=5, facecolor = 'none', edgecolor='blue', label = 'Synthetic data')
plt.title("Histogram for each year of annual energy")
