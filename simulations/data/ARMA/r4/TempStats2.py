...
for file in fnames2:
    ...
    if file not in ['synData.csv','synDataT.csv','synDataWind.csv','dataSet.csv', '102574_35.93_-115.26_2004.csv', 'romMeta.csv','solar_data_without_clearsky.csv']:
        ...
        if file[:32] == 'solar_data_without_clearsky15.csv':
        ...
        if file[:32] == 'solar_data_without_clearsky1.csv':
            ...
            ax2.hist(oy, bins=15, facecolor = 'none', edgecolor='red', color = 'g',label = 'Original data')
            ax3.plot(sorteddata, x_list, color = 'g', label = 'Original data')
            ax3.legend(loc = 'upper left')
            ax4.hist(oy, bins=15, facecolor = 'none', edgecolor='red', color = 'g',label = 'Original data')
        ...
        if file[:27] == 'solar_data_without_clearsky':
            ...
            # #ax2.hist(dni_wz, bins=40, facecolor = 'none', edgecolor='red', color = 'r',label = 'Original data', zorder = 101)
            ax2.hist(yb, bins=15, facecolor = 'none', edgecolor='red', color = 'r',label = 'Original data', zorder = 101)
