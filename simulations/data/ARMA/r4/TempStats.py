...
for file in fnames2:
    ...
    if file not in ['synData.csv','dataSet.csv', '102574_35.93_-115.26_2004.csv', 'romMeta.csv']:
        ...
        sorted_temp = np.sort(yb)
        #sorted_dni = np.sort(yb)
        
        # get the cdf values of y
        x_list = np.arange(len(sorted_temp)) / float(len(sorted_temp))
        ...
        if file[:31] == 'solar_data_without_clearsky.csv':
            ...
            ax1.plot(sorted_temp, x_list, color = 'r', label = 'Original data', zorder = 101)
            #ax2.hist(dni_wz, bins=40, facecolor = 'none', edgecolor='red', color = 'r',label = 'Original data', zorder = 101)
            ax2.hist(oy, bins=40, facecolor = 'none', edgecolor='red', color = 'r',label = 'Original data', zorder = 101)
            ax3.plot(sorted_temp, x_list, color = 'r', label = 'Original data', zorder = 101)
            ax3.legend(loc = 'upper left')
            ax4.hist(oy, bins=40, facecolor = 'none', edgecolor='red', color = 'r',label = 'Original data', zorder = 101)
            ...
            ax1.plot(sorted_temp, x_list, color = 'b')
            #ax2.hist(dni_wz, facecolor = 'none', bins=40, edgecolor='b', color = 'b')
            ax2.hist(yb, facecolor = 'none', bins=40, edgecolor='b', color = 'b')
            ax3.plot(sorted_temp, x_list, color = 'b')
            #ax2.hist(dni_wz, facecolor = 'none', bins=40, edgecolor='b', color = 'b')
            ax4.hist(yb, facecolor = 'none', bins=40, edgecolor='b', color = 'b')
