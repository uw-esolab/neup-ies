...
if __name__ == "__main__":
	...
	ssc.data_set_string( data, b'solar_resource_file', b'C:/Users/aidan/projects/neup-ies/simulations/data/ARMA/r4/102574_35.93_-115.26_2004.csv' );
	...
	ssc.data_set_array_from_csv( data, b'dc_lifetime_losses', b'C:/Users/aidan/projects/neup-ies/simulations/data/ARMA/r4/PTcase/dc_lifetime_losses.csv');
	ssc.data_set_number( data, b'en_ac_lifetime_losses', 0 )
	ssc.data_set_array_from_csv( data, b'ac_lifetime_losses', b'C:/Users/aidan/projects/neup-ies/simulations/data/ARMA/r4/PTcase/ac_lifetime_losses.csv');
	...
	ssc.data_set_array_from_csv( data, b'load', b'C:/Users/aidan/projects/neup-ies/simulations/data/ARMA/r4/PTcase/load.csv');
	ssc.data_set_array_from_csv( data, b'crit_load', b'C:/Users/aidan/projects/neup-ies/simulations/data/ARMA/r4/PTcase/crit_load.csv');
	load_escalation =[ 0 ];
	...
	ssc.data_set_number( data, b'batt_computed_strings', 375 )
	ssc.data_set_number( data, b'batt_computed_series', 139 )
	ssc.data_set_number( data, b'batt_computed_bank_capacity', 600.47998046875 )
	...
	ssc.data_set_array_from_csv( data, b'batt_room_temperature_celsius', b'C:/Users/aidan/projects/neup-ies/simulations/data/ARMA/r4/PTcase/batt_room_temperature_celsius.csv');
	...
	ssc.data_set_array_from_csv( data, b'batt_target_power', b'C:/Users/aidan/projects/neup-ies/simulations/data/ARMA/r4/PTcase/batt_target_power.csv');
	...
	ssc.data_set_array_from_csv( data, b'ur_ts_buy_rate', b'C:/Users/aidan/projects/neup-ies/simulations/data/ARMA/r4/PTcase/ur_ts_buy_rate.csv');
