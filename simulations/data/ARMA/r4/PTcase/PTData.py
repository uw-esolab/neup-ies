...
plt.legend()
plt.savefig('Figures1/Annual Energy Production'+variable+'.png')
plt.show()
...
plt.legend()
plt.savefig('Figures1/CapacityFactor'+variable+'.png')
plt.show()
...
plt.legend()
plt.savefig('Figures1/PPA'+variable+'.png')
plt.show()
...
plt.legend()
plt.savefig('Figures1/LCOE'+variable+'.png')
plt.show()
...
plt.xlabel('NPV / $ ')
plt.legend()
plt.savefig('Figures1/NPV'+variable+'.png')
plt.show()
...
plt.legend()
plt.savefig('Figures1/NCC'+variable+'.png')
plt.show()