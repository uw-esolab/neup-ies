...
for file in synfiles:    
    annualenergy, capfactor, ppa, lcoe, npv, cost = pvrun(file)
...
plt.legend()
plt.savefig('PVCase/Figures/Annual Energy Production'+variable+choice+'.png')
plt.show()
...
plt.legend()
plt.savefig('PVCase/Figures/CapacityFactor'+variable+choice+'.png')
plt.show()
...
plt.legend()
plt.savefig('PVCase/Figures/PPA'+variable+choice+'.png')
plt.show()
...
plt.legend()
plt.savefig('PVCase/Figures/LCOE'+variable+choice+'.png')
plt.show()
...
plt.xlabel('NPV / $ ')
plt.legend()
plt.savefig('PVCase/Figures/NPV'+variable+choice+'.png')
plt.show()
...
plt.legend()
plt.savefig('PVCase/Figures/NCC'+variable+choice+'.png')
plt.show()