...
for file in fnames2:
    ...
    if file not in ['synData.csv','synDataRH.csv','synDataT.csv','synDataWind.csv','dataSet.csv', '102574_35.93_-115.26_2004.csv', 'romMeta.csv','solar_data_without_clearsky.csv']:
